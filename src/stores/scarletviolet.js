...
export const useScarletVioletStore = defineStore('scarletViolet', () => {
    ...
    pokedexMap.value.set(`Spidops`, 13);
    ...
    pokedexMap.value.set(`Wooper`, 53);
    pokedexMap.value.set(`Clodsire`, 54);
    pokedexMap.value.set(`Psyduck`, 55);
    pokedexMap.value.set(`Golduck`, 56);
    pokedexMap.value.set(`Chewtle`, 57);
    pokedexMap.value.set(`Drednaw`, 58);
    pokedexMap.value.set(`Igglybuff`, 59);
    pokedexMap.value.set(`Jigglypuff`, 60);
    pokedexMap.value.set(`Wigglytuff`, 61);
    pokedexMap.value.set(`Ralts`, 62);
    pokedexMap.value.set(`Kirlia`, 63);
    pokedexMap.value.set(`Gardevoir`, 64);
    pokedexMap.value.set(`Gallade`, 65);
    pokedexMap.value.set(`Drowzee`, 66);
    pokedexMap.value.set(`Hypno`, 67);
    pokedexMap.value.set(`Gastly`, 68);
    pokedexMap.value.set(`Haunter`, 69);
    pokedexMap.value.set(`Gengar`, 70);
    pokedexMap.value.set(`Tandemaus`, 71);
    pokedexMap.value.set(`Maushold`, 72);
    pokedexMap.value.set(`Pichu`, 73);
    pokedexMap.value.set(`Pikachu`, 74);
    pokedexMap.value.set(`Raichu`, 75);
    pokedexMap.value.set(`Fidough`, 76);
    pokedexMap.value.set(`Dachsbun`, 77);
    pokedexMap.value.set(`Slakoth`, 78);
    pokedexMap.value.set(`Vigoroth`, 79);
    pokedexMap.value.set(`Slaking`, 80);
    pokedexMap.value.set(`Bounsweet`, 81);
    pokedexMap.value.set(`Steenee`, 82);
    pokedexMap.value.set(`Tsareena`, 83);
    pokedexMap.value.set(`Smoliv`, 84);
    pokedexMap.value.set(`Dolliv`, 85);
    pokedexMap.value.set(`Arboliva`, 86);
    pokedexMap.value.set(`Bonsly`, 87);
    pokedexMap.value.set(`Sudowoodo`, 88);
    pokedexMap.value.set(`Rockruff`, 89);
    pokedexMap.value.set(`Lycanroc`, 90);
    pokedexMap.value.set(`Rolycoly`, 91);
    pokedexMap.value.set(`Carkol`, 92);
    pokedexMap.value.set(`Coalossal`, 93);
    pokedexMap.value.set(`Shinx`, 94);
    pokedexMap.value.set(`Luxio`, 95);
    pokedexMap.value.set(`Luxray`, 96);
    pokedexMap.value.set(`Starly`, 97);
    pokedexMap.value.set(`Staravia`, 98);
    pokedexMap.value.set(`Staraptor`, 99);
    pokedexMap.value.set(`Oricorio`, 100);
    pokedexMap.value.set(`Mareep`, 101);
    pokedexMap.value.set(`Flaaffy`, 102);
    pokedexMap.value.set(`Ampharos`, 103);
    pokedexMap.value.set(`Petilil`, 104);
    pokedexMap.value.set(`Lilligant`, 105);
    pokedexMap.value.set(`Shroomish`, 106);
    pokedexMap.value.set(`Breloom`, 107);
    pokedexMap.value.set(`Applin`, 108);
    pokedexMap.value.set(`Flapple`, 109);
    pokedexMap.value.set(`Appletun`, 110);
    pokedexMap.value.set(`Spoink`, 111);
    pokedexMap.value.set(`Grumpig`, 112);
    pokedexMap.value.set(`Squawkabilly`, 113);
    pokedexMap.value.set(`Misdreavus`, 114);
    pokedexMap.value.set(`Mismagius`, 115);
    pokedexMap.value.set(`Makuhita`, 116);
    pokedexMap.value.set(`Hariyama`, 117);
    pokedexMap.value.set(`Crabrawler`, 118);
    pokedexMap.value.set(`Crabominable`, 119);
    pokedexMap.value.set(`Salandit`, 120);
    pokedexMap.value.set(`Salazzle`, 121);
    pokedexMap.value.set(`Phanpy`, 122);
    pokedexMap.value.set(`Donphan`, 123);
    pokedexMap.value.set(`Cufant`, 124);
    pokedexMap.value.set(`Copperajah`, 125);
    pokedexMap.value.set(`Gible`, 126);
    pokedexMap.value.set(`Gabite`, 127);
    pokedexMap.value.set(`Garchomp`, 128);
    pokedexMap.value.set(`Nacli`, 129);
    pokedexMap.value.set(`Naclstack`, 130);
    pokedexMap.value.set(`Garganacl`, 131);
    pokedexMap.value.set(`Wingull`, 132);
    pokedexMap.value.set(`Pelipper`, 133);
    pokedexMap.value.set(`Magikarp`, 134);
    pokedexMap.value.set(`Gyarados`, 135);
    pokedexMap.value.set(`Arrokuda`, 136);
    pokedexMap.value.set(`Barraskewda`, 137);
    pokedexMap.value.set(`Basculin`, 138);
    pokedexMap.value.set(`Gulpin`, 139);
    pokedexMap.value.set(`Swalot`, 140);
    pokedexMap.value.set(`Meowth`, 141);
    pokedexMap.value.set(`Persian`, 142);
    pokedexMap.value.set(`Drifloon`, 143);
    pokedexMap.value.set(`Drifblim`, 144);
    pokedexMap.value.set(`Flabébé`, 145);
    pokedexMap.value.set(`Floette`, 146);
    pokedexMap.value.set(`Florges`, 147);
    pokedexMap.value.set(`Diglett`, 148);
    pokedexMap.value.set(`Dugtrio`, 149);
    pokedexMap.value.set(`Torkoal`, 150);
    pokedexMap.value.set(`Numel`, 151);
    pokedexMap.value.set(`Camerupt`, 152);
    pokedexMap.value.set(`Bronzor`, 153);
    pokedexMap.value.set(`Bronzong`, 154);
    pokedexMap.value.set(`Axew`, 155);
    pokedexMap.value.set(`Fraxure`, 156);
    pokedexMap.value.set(`Haxorus`, 157);
    pokedexMap.value.set(`Mankey`, 158);
    pokedexMap.value.set(`Primeape`, 159);
    pokedexMap.value.set(`Annihilape`, 160);
    pokedexMap.value.set(`Meditite`, 161);
    pokedexMap.value.set(`Medicham`, 162);
    pokedexMap.value.set(`Riolu`, 163);
    pokedexMap.value.set(`Lucario`, 164);
    pokedexMap.value.set(`Charcadet`, 165);
    pokedexMap.value.set(`Armarouge`, 166);
    pokedexMap.value.set(`Ceruledge`, 167);
    pokedexMap.value.set(`Barboach`, 168);
    pokedexMap.value.set(`Whiscash`, 169);
    pokedexMap.value.set(`Tadbulb`, 170);
    pokedexMap.value.set(`Bellibolt`, 171);
    pokedexMap.value.set(`Goomy`, 172);
    pokedexMap.value.set(`Sliggoo`, 173);
    pokedexMap.value.set(`Goodra`, 174);
    pokedexMap.value.set(`Croagunk`, 175);
    pokedexMap.value.set(`Toxicroak`, 176);
    pokedexMap.value.set(`Wattrel`, 177);
    pokedexMap.value.set(`Kilowattrel`, 178);
    pokedexMap.value.set(`Eevee`, 179);
    pokedexMap.value.set(`Vaporeon`, 180);
    pokedexMap.value.set(`Jolteon`, 181);
    pokedexMap.value.set(`Flareon`, 182);
    pokedexMap.value.set(`Espeon`, 183);
    pokedexMap.value.set(`Umbreon`, 184);
    pokedexMap.value.set(`Leafeon`, 185);
    pokedexMap.value.set(`Glaceon`, 186);
    pokedexMap.value.set(`Sylveon`, 187);
    pokedexMap.value.set(`Dunsparce`, 188);
    pokedexMap.value.set(`Dudunsparce`, 189);
    pokedexMap.value.set(`Deerling`, 190);
    pokedexMap.value.set(`Sawsbuck`, 191);
    pokedexMap.value.set(`Girafarig`, 192);
    pokedexMap.value.set(`Farigiraf`, 193);
    pokedexMap.value.set(`Grimer`, 194);
    pokedexMap.value.set(`Muk`, 195);
    pokedexMap.value.set(`Maschiff`, 196);
    pokedexMap.value.set(`Mabosstiff`, 197);
    pokedexMap.value.set(`Toxel`, 198);
    pokedexMap.value.set(`Toxtricity`, 199);
    pokedexMap.value.set(`Dedenne`, 200);
    pokedexMap.value.set(`Pachirisu`, 201);
    pokedexMap.value.set(`Shroodle`, 202);
    pokedexMap.value.set(`Grafaiai`, 203);
    pokedexMap.value.set(`Stantler`, 204);
    pokedexMap.value.set(`Foongus`, 205);
    pokedexMap.value.set(`Amoonguss`, 206);
    pokedexMap.value.set(`Voltorb`, 207);
    pokedexMap.value.set(`Electrode`, 208);
    pokedexMap.value.set(`Magnemite`, 209);
    pokedexMap.value.set(`Magneton`, 210);
    pokedexMap.value.set(`Magnezone`, 211);
    pokedexMap.value.set(`Ditto`, 212);
    pokedexMap.value.set(`Growlithe`, 213);
    pokedexMap.value.set(`Arcanine`, 214);
    pokedexMap.value.set(`Teddiursa`, 215);
    pokedexMap.value.set(`Ursaring`, 216);
    pokedexMap.value.set(`Zangoose`, 217);
    pokedexMap.value.set(`Seviper`, 218);
    pokedexMap.value.set(`Swablu`, 219);
    pokedexMap.value.set(`Altaria`, 220);
    pokedexMap.value.set(`Skiddo`, 221);
    pokedexMap.value.set(`Gogoat`, 222);
    pokedexMap.value.set(`Tauros`, 223);
    ...
    pokedexMap.value.set(`Hippowdon`, 266);
    ...
    pokedexMap.value.set(`Palafin`, 292);
    ...
    pokedexMap.value.set(`Falinks`, 300);
    pokedexMap.value.set(`Hawlucha`, 301);
    pokedexMap.value.set(`Spiritomb`, 302);
    ...
    pokedexMap.value.set(`Eelektrik`, 342);
    pokedexMap.value.set(`Eelektross`, 343);
